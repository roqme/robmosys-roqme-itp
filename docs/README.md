...
## Pre-Installation (see the video tutorial available [here](https://youtu.be/iurFblG7XtM))
...
16.	Installation of the RoQME Plugin:
    ...
    1.	Restart Eclipse
 
## Using RoQME within SmartMDSD (see the video tutorial available [here](https://youtu.be/gFZyDYMYBtk))
...
4.	Compiling the generated C/C++ code.
	...
	Both the RoQME Data Space (based on DDS) and the probabilistic reasoner are implemented in C++ and, thus, need to be compiled following the steps indicated next:
