 ...
 * </p>
 * <ul>
 *   <li>{@link roqme.metamodel.datatypes.impl.ArrayValueImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayValueImpl extends TypedValueImpl implements ArrayValue {
	/**
	...
	protected EClass eStaticClass() {
		return DatatypesPackage.Literals.ARRAY_VALUE;
	}
	...
	public EList<SingleValue> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<SingleValue>(SingleValue.class, this, DatatypesPackage.ARRAY_VALUE__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DatatypesPackage.ARRAY_VALUE__VALUES:
